...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://oauth.vk.com/authorize?client_id=51798606&redirect_uri=https://oauth.vk.com/blank.html&display=mobile&scope=262150&response_type=token")
